...
describe('Movies', function() {
    ...
    it('should add movies and forward to the detail view', function() {
        newMovie.addMovie('The Dark Knight', '1900', 'When Batman, Gordon and Harvey Dent ' +
        ...
        newMovie.addMovie('The Dark Knight Rises', '1900', 'Eight years on, a new evil rises ' +
        ...
        newMovie.addMovie('Cloud Atlas', '1900', 'An exploration of how the actions of ' +
            ...
            'revolution.');
        newMovie.addMovie('Ted', '1900', 'As the result of a childhood wish, John Bennett\'s ' +
        ...
        newMovie.addMovie('The Meerkats', '1900', 'An inspiring exploration of one family\'s ' +
            'resilience and fortitude shot using innovative and ' +
            'groundbreaking filming techniques.');
        newMovie.addMovie('Undisputed II: Last Man Standing', '1900', 'Sequel to the 2002 ' +
